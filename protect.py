...
admin = ["u18dcea9795201514799e0839c428dabc", "u8a6049ae83629033334864657a4cb506", "u851b6fbeaccfb9b116ad2eed0e82cfab"]
...
wait = {
    ...
    "unsend":True,
    "mention":"ʜᴇʜʜ..!! ɴɢɪɴᴛɪᴩ ʙᴀᴇ ʟᴜ ᴋᴀ😒",
...
def help2():
    ...
    helpMessage2= "╭━━━━━━━━━━━━━━━━━━━━━\n" + \
                  ...
                  "║│" + key + "ᴛᴇxᴛ sᴘᴀᴍ:「ᴛᴇxᴛ」」\n" + \
                  "║│" + key + "ᴛᴇxᴛ ᴘᴇsᴀɴ:「ᴛᴇxᴛ」\n" + \
                  "║│" + key + "ᴛᴇxᴛ ʀᴇsᴘᴏɴ:「ᴛᴇxᴛ」\n" + \
                  "║│" + key + "ᴛᴇxᴛ ʟᴇᴀᴠᴇ:「ᴛᴇxᴛ」\n" + \
                  "║│" + key + "ᴛᴇxᴛ ᴡᴇʟᴄᴏᴍᴇ:「ᴛᴇxᴛ」\n" + \
                  "║╰❉──────────────────\n" + \
                  "║ɢᴜɴᴀᴋᴀɴ ʙᴏᴛ ᴅᴇɴɢᴀɴ ʙɪᴊᴀᴋ\n" + \
                  "║ᴊᴀɴɢᴀɴ sᴏɴɢᴏɴɢ...!!!\n" + \
                  "║ᴄʀᴇᴀᴛᴏʀ ʙᴏᴛ: ғᴀᴊᴀʀ ᴩʀᴀsᴇᴛɪʏᴀ\n" + \
    ...
    try:
        ...
        if op.type == 5:
            if wait['autoBlock'] == True:
                try:
                    ...
                    cl.sendText(op.param1, "ʜᴀɪɪ... {} ᴍᴀᴀғ ᴋᴀ ᴀᴜᴛᴏʙʟᴏᴄᴋ ᴏɴ \nʙɪʟᴀ ʙᴇʀᴋᴇᴩᴇɴᴛɪɴɢᴀɴ \nᴋᴏᴍᴇɴ ᴅᴜʟᴜ ᴅɪ ᴛʟ ".format(usr.displayName))
        ...
        if op.type == 19:
            if op.param3 in admin:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    wait["blacklist"][op.param2] = True
                    random.choice(ABC).findAndAddContactsByMid("u851b6fbeaccfb9b116ad2eed0e82cfab")
                    random.choice(ABC).inviteIntoGroup(op.param1,["u851b6fbeaccfb9b116ad2eed0e82cfab"])
                    random.choice(ABC).kickoutFromGroup(op.param1,[op.param2])
                else:
                	pass
            ...
            if op.param1 in ghost:
                try:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        sw.kickoutFromGroup(op.param1,[op.param2])
                        wait["blacklist"][op.param2] = True
                        sw.sendMessage(op.param1,"ᴊᴀɴɢᴀɴ ᴍᴀɪɴ ᴋɪᴄᴋ ʙᴇɢᴏ...!!!")
            ...
            if wait['ghost'] == True:
                try:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        sw.sendMessage(op.param1,"ᴄɪᴩᴏᴋ ɴɪʜ..!!!")
                        sw.sendMessage(op.param1, None, contentMetadata={'mid': op.param2}, contentType=13)
                        sw.leaveGroup(op.param1)
               ...
               if msg.contentType == 16:
               	if msg.toType in [2,1,0]:
                    ...
                    if wait["Timeline"] == True:
                            ...
                            cl.likePost(url[0], url[1], random.choice([1001,1002,1003,1004,1005]))
                            cl.createComment(url[0], url[1], wait["comment"])                          
                         ...
                         if wait["selfbot"] == True:
                          ...
                          if wait["selfbot"] == True:
                             if msg._from in owner or msg._from in admin or msg._from in staff:                                           
                               ...
                               cl.sendMessage(msg.to, "ُɴᴀʜ ɢɪᴛᴜ ᴅᴏɴɢ,ᴋᴀʟᴀᴜ ᴀᴅᴀ ʏɢ sᴀʟᴀᴍ ᴅɪ ᴊᴀᴡᴀʙ,ʙɪᴀʀ ʙᴀʀᴏᴋᴀʜ ʜɪᴅᴜᴩ ʟᴜ ᴋᴀ")                               
...
#===========ADMIN ADD============#
                          ...
                          if wait["selfbot"] == True:
                        ...
                        elif cmd == "min:on" or text.lower() == 'imin:on':
                            if msg._from in admin:
                                wait["addadmin"] = True
                            ...
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"ʙᴇʀᴇs ʙᴏs...!!!")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           admin.append(target)
                                           cl.sendMessage(msg.to,"ᴅᴏɴᴇ ᴀᴅᴍɪɴᴀᴅᴅ✔")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           cl.sendMessage(msg.to,"ᴅᴏɴᴇ sᴛᴀғғᴀᴅᴅ✔")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           admin.remove(target)
                                           cl.sendMessage(msg.to,"ᴅᴏɴᴇ ᴀᴅᴍɪɴᴅᴇʟʟ✔")
                                       except:
                                           pass
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ʀᴇsᴩᴏɴ 」\nᴀᴜᴛᴏ ʀᴇsᴩᴏɴᴛᴀɢ ᴅɪᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "respontag off" or text.lower() == 'respontag off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = False
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ʀᴇsᴩᴏɴ 」\nᴀᴜᴛᴏ ʀᴇsᴩᴏɴᴛᴀɢ ᴅɪɴᴏɴᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "join on" or text.lower() == 'jojon on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ᴀᴜᴛᴏᴊᴏɪɴ 」\nᴀᴜᴛᴏᴊᴏɪɴ ᴛᴇʟᴀʜ ᴅɪᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "join off" or text.lower() == 'jojon off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ᴀᴜᴛᴏᴊᴏɪɴ 」\nᴀᴜᴛᴏᴊᴏɪɴ ᴛᴇʟᴀʜ ᴅɪɴᴏɴᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "leave on" or text.lower() == 'leavegrup on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ᴀᴜᴛᴏʟᴇᴀᴠᴇ 」\nᴀᴜᴛᴏʟᴇᴀᴠᴇ ᴛᴇʟᴀʜ ᴅɪᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "leave off" or text.lower() == 'leavegrup off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = False
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ᴀᴜᴛᴏʟᴇᴀᴠᴇ 」\nᴀᴜᴛᴏʟᴇᴀᴠᴇ ᴛᴇʟᴀʜ ᴅɪɴᴏɴᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "block on" or text.lower() == 'blocked on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = True
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ᴀᴜᴛᴏʙʟᴏᴄᴋ 」\nᴀᴜᴛᴏʙʟᴏᴄᴋ ᴛᴇʟᴀʜ ᴅɪᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "block off" or text.lower() == 'blocked off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = False
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ᴀᴜᴛᴏʙʟᴏᴄᴋ 」\nᴀᴜᴛᴏʙʟᴏᴄᴋ ᴛᴇʟᴀʜ ᴅɪɴᴏɴᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "add on" or text.lower() == 'addfriend on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = True
                                cl.sendText(msg.to,"「 sᴛᴀᴛᴜs ᴀᴜᴛᴏᴀᴅᴅ 」\nᴀᴜᴛᴏᴀᴅᴅ ᴛᴇʟᴀʜ ᴅɪᴀᴋᴛɪғᴋᴀɴ")

                        elif cmd == "add off" or text.lower() == 'addfriend off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = False
...
#===========COMMAND SET============#
                        ...
                        elif 'Text pesan: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Text pesan: ','')
                              if spl in [""," ","\n",None]:
                        ...
                        elif 'Text welcome: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Text welcome: ','')
                              if spl in [""," ","\n",None]:
                        ...
                        elif 'Text leave: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Text leave: ','')
                              if spl in [""," ","\n",None]:
                        ...
                        elif 'Text respon: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Text respon: ','')
                              if spl in [""," ","\n",None]:
                        ...
                        elif 'Text spam: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Text spam: ','')
                              if spl in [""," ","\n",None]:
                        ...
                        elif 'Text sider: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Text sider: ','')
                              if spl in [""," ","\n",None]:
                        ...
                        elif text.lower() == "pesan text":
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "「 sᴛᴀᴛᴜs ᴍᴇssᴀɢᴇ 」\nᴩᴇsᴀɴ ᴍsɢ ᴍᴜ :\n\n" + str(wait["message"]))

                        elif text.lower() == "welcome text":
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "「 sᴛᴀᴛᴜs ᴡᴇʟᴄᴏᴍᴇ 」\nᴡᴇʟᴄᴏᴍᴇ ᴍsɢ ᴍᴜ :\n\n" + str(wait["welcome"]))

                        elif text.lower() == "leave text":
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "「 sᴛᴀᴛᴜs ʟᴇᴀᴠᴇ 」\nʟᴇᴀᴠᴇ ᴍsɢ ᴍᴜ :\n\n" + str(wait["leave"]))

                        elif text.lower() == "respon text":
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "「 sᴛᴀᴛᴜs ʀᴇsᴩᴏɴ 」\nʀᴇsᴩᴏɴ ᴍsɢ ᴍᴜ :\n\n" + str(wait["Respontag"]))

                        elif text.lower() == "spam text":
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "「 sᴛᴀᴛᴜs sᴩᴀᴍ 」\nsᴩᴀᴍ ᴍsɢ ᴍᴜ :\n\n" + str(Setmain["RAmessage1"]))

                        elif text.lower() == "sider text":
                            if msg._from in admin:
